...
public class MultiDimensionalKalmanFilterTest {
    ...
    public void testSimplePropagation() {
        ...
        propagation
            ...
            .setInputVariable(new Vector(new double[] { -9.8 }));
        ...
        // Act
        double[] outputStateMatrix = filter.predict().transpose().getValues();
    ...
    @Test
    @Ignore
    public void testPropagationInThreeDimensions() {
        // Arrange
        double timeInterval = 1.0;
        //                                      x,  y,  z,   xv, yv, zv
        double[] previousState = new double[] { 20, -50, 12, 3,  4,  -1 };
        double[] inputVariable = new double[] { 3, 0.1, -8 };
