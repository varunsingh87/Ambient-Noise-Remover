...
public class MatrixTest {
    ...
    public void testMatrixCanBeCompared() {
        Matrix comparerMatrix = new Matrix(new double[][] {
            { 10, 5, 10 },
            { 20, 5, 20 }
        });

        Matrix compareeMatrix = new Matrix(new double[][] {
            { 10, 5, 10 },
            { 20, 5, 20 }
        });

        Matrix unequalMatrix = new Matrix(new double[][] {
            { 1, 2, 3 },
            { 3, 1, 2 },
            { 2, 3, 1 }
        });
    ...
    public void testMatrixMultiplication() {
        ...
        assertEquals(new Matrix(new double[][] { { 75.0 } }), result);
    }
